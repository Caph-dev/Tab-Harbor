...
(function attachTabHarborI18n(globalScope) {
  ...
  const i18nMessages = {
    en: {
      ...
      searchWebPlaceholder: 'Search with your default engine...',
      ...
      shortcutIconFittingLabel: 'Icon fitting',
      shortcutIconFittingAuto: 'Auto',
      shortcutIconFittingOriginal: 'Original',
      shortcutIconFittingGlyph: 'Glyph',
      shortcutIconFittingFill: 'Fill',
      shortcutIconFittingHelp: 'Auto balances transparent marks and full-tile website icons.',
      ...
      deskPalette: 'Desk style',
      personalize: 'Personalize',
      themeStylePaperDeskName: 'Paper desk',
      themeStylePaperDeskMeta: 'Warm, literary, composed',
      themeStyleIvoryIndexName: 'Ivory index',
      themeStyleIvoryIndexMeta: 'Precise, compact, content-first',
      themeStyleHarborMistName: 'Harbor mist',
      themeStyleHarborMistMeta: 'Airy, low-pressure, cool',
      themeStyleClayNotesName: 'Clay notes',
      themeStyleClayNotesMeta: 'Warm, personal, tactile',
      themeStyleBotanicalFolioName: 'Botanical folio',
      themeStyleBotanicalFolioMeta: 'Specimen paper, sage ink, quiet taxonomy',
      themeStylePorcelainAtlasName: 'Porcelain atlas',
      themeStylePorcelainAtlasMeta: 'Glazed ivory, cobalt lines, cartographic order',
      themeStyleNocturneObservatoryName: 'Nocturne observatory',
      themeStyleNocturneObservatoryMeta: 'Indigo night, brass marks, measured depth',
      themeStyleVermilionSealName: 'Vermilion seal',
      themeStyleVermilionSealMeta: 'Rice paper, ink, restrained cinnabar',
      deskBackdrop: 'Desk backdrop',
      uploadImage: 'Upload image',
      clearText: 'Clear',
      surfaceDepth: 'Surface depth',
      drawerSpeed: 'Drawer speed',
      hitokotoLabel: 'Hitokoto',
      allowShortcutReordering: 'Allow shortcut reordering',
      reorderQuickTab: 'Reorder quick tab',
      ...
      todoBackToList: 'Back to list',
      todoBackToDetail: 'Back to detail',
      todoTitleLabel: 'Title',
      todoDetailsLabel: 'Details',
      todoTitleRequired: 'A title is required.',
      todoDetailsEmpty: 'Add a note when this task needs more context.',
      todoCreated: 'Created',
      cancel: 'Cancel',
      save: 'Save',
    ...
    'zh-CN': {
      ...
      searchWebLabel: '搜索网络',
      searchWebPlaceholder: '使用默认搜索引擎搜索...',
      ...
      shortcutIconFittingLabel: '图标适配',
      shortcutIconFittingAuto: '自动',
      shortcutIconFittingOriginal: '原图',
      shortcutIconFittingGlyph: '图形',
      shortcutIconFittingFill: '铺满',
      shortcutIconFittingHelp: '自动平衡透明标志和铺满画面的站点图标。',
      ...
      drawerSpeed: '抽屉速度',
      hitokotoLabel: '一言',
      allowShortcutReordering: '允许拖动快捷图标',
      editQuickTab: '编辑快捷链接',
      ...
      todoEdit: '编辑',
      todoRestore: '恢复待办',
      todoRestoreAction: '恢复',
      todoDeleteArchived: '删除已归档待办',
      todoBackToList: '返回列表',
      todoBackToDetail: '返回详情',
      todoTitleLabel: '标题',
      todoDetailsLabel: '详情',
      todoTitleRequired: '标题不能为空。',
      todoDetailsEmpty: '需要更多背景时，可以在这里添加备注。',
      todoCreated: '创建于',
      cancel: '取消',
      save: '保存',
  ...
  const i18nTextMapZh = {
    ...
    'Add a note when this task needs more context.': '需要更多背景时，可以在这里添加备注。',
    'Created': '创建于',
    'Add link': '添加链接',
